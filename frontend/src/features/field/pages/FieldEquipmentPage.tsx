...
const inputCls = 'w-full h-9 rounded-lg border border-slate-200 bg-white px-3 text-sm text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 transition-colors'
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-semibold uppercase tracking-widest text-slate-400">Search</label>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${category === 'all' ? 'bg-slate-900 text-white' : 'border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 hover:border-slate-400'}`}
                >
                  All categories
                </button>
                {categories.map((c) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${category === c ? 'bg-slate-900 text-white' : 'border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 hover:border-slate-400'}`}
                  >
                    {c}
                  </button>
                ))}
